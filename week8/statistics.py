    ...
    def _set_user_wins(self):
        ...
        for _, row in data_df.iterrows():
            ...
            if row["game_result"] == "X":
                current_win_username = row["x_username"]
                current_lose_username = row["o_username"]
            elif row["game_result"] == "O":
                current_win_username = row["o_username"]
                current_lose_username = row["x_username"]
            else:  # draw
                current_draw_x_username = row["x_username"]
                current_draw_o_username = row["o_username"]
