import unittest
import logic
from logic import SingleModeGame
...
class TestGameMode(unittest.TestCase):
    def test_validate_game_mode_input(self):
        ...
        :return:
        """
        self.assertTrue(logic.validate_game_mode_input("1"))
        self.assertTrue(logic.validate_game_mode_input("2"))

        self.assertFalse(logic.validate_game_mode_input("abc"))
        self.assertFalse(logic.validate_game_mode_input("-30"))
    ...
    def test_validate_input(self):
        ...
        self.assertTrue(logic.validate_input(test_board, "1", "1"))
        self.assertFalse(logic.validate_input(test_board, "3", "3"))
        self.assertFalse(logic.validate_input(test_board, "0", "0"))
